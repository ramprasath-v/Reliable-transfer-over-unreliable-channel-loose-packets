    ...
    else
    {
        while(!feof(fp))
        {
            ...
            if(n>0)
            {
                ...
                printf("Appended check sum in client = %hu\n", udp.chksum);                
                if (flag%2 == 0)
                {
                    ...
                    else
                    {
                        ...
                        //sprintf("value of m %d\n", m);
                        while(msg == NULL || strcmp(msg,"ack0") !=0)
                        {
                            printf("Packet lost or ack0 not received\n");
                            ...
                            {
                                printf("\nAcknowledgement from server for seq 0 packets = %s \n",msg);
                            }
                        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while(msg == NULL || strcmp(msg,"ack1") !=0)
                        {
                            printf("Packet lost or ack1 not received\n");
                            ...
                            {
                                printf("\nAcknowledgement from server for seq 1 packets = %s \n",msg);
                            }
                        }
